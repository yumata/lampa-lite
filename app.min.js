  ...
  function profile() {
    ...
    body$2.find('.settings--account-user-profile').on('hover:enter', function () {
      ...
      network$7.silent(api + 'profiles/all', function (result) {
        ...
        Noty$1.show('Не удалось получить список профилей');
      }, false, {
        headers: {
          token: account.token
        }
      ...
      if (SpeechRecognition) {
        ...
        recognition.addEventListener("error", function (event) {
          ...
          if (event.error == 'not-allowed') {
            Noty$1.show('Нет доступа к микрофону');
          }
        ...
        onSelect: function onSelect(a) {
          if (a.add) {
            if (members.indexOf(a.subtitle) == -1) {
              ...
              Noty$1.show('Добавлено (' + a.subtitle + ')');
            } else {
              Arrays.remove(members, a.subtitle);
              Noty$1.show('Удалено (' + a.subtitle + ')');
            }
