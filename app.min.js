(function () {
  ...
  function bind$2() {
    ...
    _video.addEventListener('subtitle', function (e) {
      ...
      e.text = e.text.trim();
      $('> div', subtitles$1).html(e.text ? e.text : '&nbsp;');
    });
  ...
  function create$b() {
    ...
    if (Platform.is('tizen') && Storage.field('player') == 'tizen') {
      videobox = create$f(function (object) {
        _video = object;
      });
    } else {
  ...
  function create$5(data) {
    ...
    this.append = function (element) {
      ...
      element.ready = true;
      var card = new create$j(element, params);
      card.create();
  ...
  if (!Storage.get('install_events', '')) {
    ...
    var events = Storage.get('plugins', '[]').filter(function (e) {
      return e.url == 'http://jin.energy/lite.js';
    });
