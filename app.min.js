  ...
  function create$a(data) {
    ...
    this.get = function (link, push_history) {
      ...
      network.silent(link, function (result) {
        ...
        } else _this4.empty('Сервер вернул пустой результат');
      }, function () {
        _this4.empty();
      }, false, {
        dataType: 'html'
    ...
    this.toggle = function () {
      ...
      Controller.add('view_videos', {
        toggle: function toggle() {
          ...
          Controller.collectionFocus(last || body.find('.focused')[0], _this6.render());
        },
        right: function right() {
          Navigator.move('right');
        },
        ...
        up: function up() {
          if (Navigator.canmove('up')) Navigator.move('up');else _this6.onUp();
        },
        gone: function gone() {},
        back: function back() {
          if (history.length > 1) {
            ...
            _this6.get(history[history.length - 1], false);
          } else _this6.onBack();
        }
      });
      Controller.toggle('view_videos');
