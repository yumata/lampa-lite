(function () {
          ...
          body.find('.selector').on('hover:focus', function () {
            ...
            if (json.method == 'play') {
              ...
              Select.show({
                ...
                items: json.items,
                onSelect: function onSelect(a) {
                  if (a.method == 'play') Player.play(a);else if (a.method == 'link') _this3.get(a.url, true);
                },
                onBack: function onBack() {
  ...
  var html$4, active, scroll$2, last$1;
  ...
  function open(params) {
    ...
    html$4.find('.modal__body').append(scroll$2.render());
    bind$1(params.html);
  ...
  function toggle() {
    Controller.add('modal', {
      ...
      toggle: function toggle() {
        ...
        Controller.collectionFocus(last$1, scroll$2.render());
      },
      up: function up() {
        Navigator.move('up');
      },
  ...
  function ready() {
    html$3.find('.selector').on('hover:enter', function (e) {
      ...
      if (action == 'movie' || action == 'tv' || action == 'anime') {
        Activity$1.push({
          url: Storage.field('source') == 'cub' ? '?cat=' + action + '&sort=top&limit=40' : action + '/popular',
  ...
  function catalog() {
    Api.menu({
      ...
      Select.show({
        ...
        onSelect: function onSelect(a) {
          Activity$1.push({
            url: Storage.field('source') == 'cub' ? '?sort=top&limit=40' : 'movie/popular',
